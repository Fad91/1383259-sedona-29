...
* Студент: [Антон Куклин](https://up.htmlacademy.ru/htmlcss/29/user/1383259).
* Наставник: `Владислав Кривокора`. Дубль 2)
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1383259-sedona-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
